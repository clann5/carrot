...
본 사이트는 "Carrot Market(짭) 공식 홈페이지"로 칭하며 본 사이트의 운영주체는 Carrot Market(짭)입니다.
...
본 사이트 회원이란 Carrot Market(짭)가 회원으로 적합하다고 인정하는 일반 개인으로서, 본 약관에 동의하고 Carrot Market(짭)가 인정하는 본 사이트의 회원가입양식을 작성한 뒤 고유의 ID와 PASSWORD를 발급 받은 자를 말합니다.
...
본 사이트에서 볼 수 있는 모든 자료는 Carrot Market(짭) 에서 본 사이트로만 제공하는 정보입니다.
...
Carrot Market(짭)의 개인정보보호정책

Carrot Market(짭)는 이용자 여러분의 개인정보를 보호하기 위해 개인정보보호정책을 수립하고 이를 준수합니다.

"Carrot Market(짭)의 개인정보보호정책"은 수시로 변경될 수 있습니다. 따라서 이용자 여러분께서는 예문사 사이트를 이용하실 때마다 수시로 이를 확인하시기 바랍니다.
...
Carrot Market(짭)는 서비스 제공에 필요한 최소한의 정보를 수집합니다.
...
Carrot Market(짭)에서 수집하는 개인정보는 다음에 명시한 목적으로만 이용됩니다.
...
Carrot Market(짭)은 법령에 근거한 다음의 경우를 제외하고는 제3자에게 개인정보를 제공하지 않습니다.
...
Carrot Market(짭)의 쿠키 운영

Carrot Market(짭)은 이용자의 편의를 위하여 쿠키를 운영합니다.
웹클래스가 쿠키를 통해 수집하는 정보는 예문사 회원 ID에 한하며, 그 외의 다른 정보는 수집하지 않습니다. Carrot Market(짭)이 쿠키(cookie)를 통해 수집한 회원 ID는 아래의 목적을 위해 사용됩니다. 
1) Carrot Market(짭) 각종 정보 서비스 이용 시
2) 개인 맞춤 서비스 제공
...
Carrot Market(짭) (02)1588-1111, Carrot@Market.com

한편, 회원님께서는 Carrot Market(짭)와 개인정보에 관한 분쟁이 있는 경우 신속하고 효과적인 
